...
/**
 * This is an OTLL form that is created to take input of user id from admin only 
 * and also validate the data of the form through ajax and generate the one time
...
class OtllForm extends FormBase 
{
  ...
  /**
   * This function is used to take the id of the user and check if it exists or 
   * not. If exist then create a one time login link and display it to the admin.
   *
   * @param array $form
